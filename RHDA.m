function [eigvector, eigvector2, X_new] = RHDA(X, options)
% RHDA: Robust Heterogeneous Discriminative Analysis 
%
%       [eigvector, label] = RHDA(X, options)
% 
%             Input:
...
%
%             Output:
%               eigvector - Set of projection basis for DMME
%               eigvector2 - Shared projection basis for DSME
